...
// VertexManipulationBuffer: Contains data for vertex manipulation, including height map strength
cbuffer VertexManipulationBuffer : register(b1)
{
    float4 vertexManipulationData; //.x is height map strength
}
...
float GetHeight(float2 UV)
{
    ...
    return offset * 30.f; // Multiply by height map strength (30.f in this case)
}
