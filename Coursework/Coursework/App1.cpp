...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input* in, bool VSYNC, bool FULL_SCREEN)
{
	...
	lightShaderTess = new LightShader(renderer->getDevice(), hwnd, L"VertexManipulation_vs.cso", L"VertexManipulation_hs.cso", L"VertexManipulation_ds.cso", L"light_ps.cso");
...
void App1::lighting(RenderTexture* renderTexture, bool clear) {
	...
	lightShaderTess->setShaderParametersTess(
		...
		textureMgr->getTexture(L"heightMap"), // Height map texture for terrain.
		heightMapStrength,  // Strength of the height map effect.
...
// Renders the application's ImGui graphical user interface.
